...
# -------------------------
DDPM_DIR = "Transient_Results/transient_results_cifar10_32_0.0_t0_to_t150"  # DDPM
ISO_DIR  = "Transient_Results/transient_results_cifar10_32_0.3_t0_to_t150"  # ISO diffusion
...
def main():
    ...
    plot_two(curves, 100,  "CIFAR-10 32×32 — SNR over diffusion timesteps", "snr_celeba64_ddpm_vs_iso")
    plot_two(curves, 1000, "CIFAR-10 32×32 — SNR over diffusion timesteps", "snr_celeba64_ddpm_vs_iso")

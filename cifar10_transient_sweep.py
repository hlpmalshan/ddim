#!/usr/bin/env python3
"""
CIFAR-10 Transient Sweep Evaluator (32×32)
=========================================

Purpose
-------
Evaluate transient diffusion samples saved at intermediate timesteps (t_*) against a
fixed REAL CIFAR-10 train set (32×32), producing per-timestep metrics + artifacts.
...
Example
-------
python3 cifar10_transient_sweep.py \
  --real_dir "/data/diffusion/repos/ddim/ddim_cifar10/datasets/cifar10/train" \
  --gen_root "/data/diffusion/repos/ddim/transient_results_cifar10_32_0.3_t0_to_t150" \
  --out_dir  "/data/diffusion/repos/ddim/transient_results_cifar10_32_0.3_t0_to_t150/eval" \
...
DEFAULT_REAL_DIR = "/data/diffusion/repos/ddim/ddim_cifar10/datasets/cifar10/train"
DEFAULT_GEN_ROOT = "/data/diffusion/repos/ddim/transient_results_cifar10_32_0.3_t0_to_t150"
DEFAULT_OUT_DIR = "/data/diffusion/repos/ddim/transient_results_cifar10_32_0.3_t0_to_t150/eval"
...
def main(cfg: SweepConfig) -> int:
    ...
    tmp_root = tempfile.mkdtemp(prefix="tmp_cifar10_transient_sweep_", dir=out_dir)
...
def _build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        "CIFAR-10 transient sweep (32×32): FID/IS (torch-fidelity) + PRDC (prdc) per timestep"
    )
    p.add_argument(
        "--real_dir",
        type=str,
        default=DEFAULT_REAL_DIR,
        help="Directory containing REAL CIFAR-10 train images (32×32).",
    )
    p.add_argument(
        "--gen_root",
        type=str,

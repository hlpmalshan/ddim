#!/usr/bin/env python3
"""
Compute transient r_Theta for CelebA reverse DDPM sampling.
...
def resolve_config_path(user_config: str | None, ckpt_path: str) -> str:
    ...
    fallback_candidates = [
        Path("configs/celeba_transient_50k.yml"),
        Path("configs/celeba.yml"),
    ]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Transient r_Theta for CelebA reverse DDPM sampling."
    )

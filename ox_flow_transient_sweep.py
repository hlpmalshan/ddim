#!/usr/bin/env python3
"""
Oxford Flowers (ox_flow) Transient Sweep Evaluator (64×64)
=========================================================

Purpose
-------
Evaluate transient diffusion samples saved at intermediate timesteps (t_*) against a
fixed REAL Oxford Flowers set, producing per-timestep metrics + artifacts.
...
Example
-------
python3 ox_flow_transient_sweep.py \
  --real_dir "/data/diffusion/repos/ddim/ddim_ox_flow/datasets/oxford_flowers/flowers-102/jpg" \
  --gen_root "/data/diffusion/repos/ddim/transient_results_ox_flow_64_0.3_t0_to_t150" \
  --out_dir  "/data/diffusion/repos/ddim/transient_results_ox_flow_64_0.3_t0_to_t150/eval" \
...
DEFAULT_REAL_DIR = "/data/diffusion/repos/ddim/ddim_ox_flow/datasets/oxford_flowers/flowers-102/jpg"
DEFAULT_GEN_ROOT = "/data/diffusion/repos/ddim/transient_results_ox_flow_64_0.3_t0_to_t150"
DEFAULT_OUT_DIR = "/data/diffusion/repos/ddim/transient_results_ox_flow_64_0.3_t0_to_t150/eval"
...
def main(cfg: SweepConfig) -> int:
    ...
    tmp_root = tempfile.mkdtemp(prefix="tmp_ox_flow_transient_sweep_", dir=out_dir)
...
def _build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        "ox_flow transient sweep (64×64): FID/IS (torch-fidelity) + PRDC (prdc) per timestep"
    )
    p.add_argument(
        "--real_dir",
        type=str,
        default=DEFAULT_REAL_DIR,
        help="Directory containing REAL Oxford Flowers images (will be resized to 64×64).",
    )
    p.add_argument(
        "--gen_root",
        type=str,

...
BASE_CONFIG="cifar100.yml"

# Experiment roots
EXP_ROOT="ddim_cifar100"          # where logs/ and image_samples/ live
...
for step in "${STEPS[@]}"; do
  ...
  for reg in "${reg_values[@]}"; do
    ...
    IDIR="cifar100_iso_${reg}_s${step}"
    GEN_DIR="$REG_GEN_DIR/$IDIR"

    TMP_CFG_NAME="_tmp_cifar100_ckpt_${step}.yml"
...
echo "CIFAR100 sampling & evaluation done (checkpoint-first, no mkdir)."
